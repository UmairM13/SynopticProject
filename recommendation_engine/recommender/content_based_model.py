...
def prepare_features(destinations_df):
    ...
    # Attach identifiers to the similarity matrix
...
if __name__ == "__main__":
    ...
    input = "Toronto"
    recommendations = recommend_similar_destinations(input, destinations_df, features_df, similarity_matrix, top_n=10)
